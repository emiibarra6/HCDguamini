<div class="py-5 bg-cover" data-dark-overlay="6" style="background: url('assets/frontend/img/1920/edit1.jpg') no-repeat">
   <div class="container"><h2 class="text-white">Documentos</h2><ol class="breadcrumb breadcrumb-double-angle text-white bg-transparent p-0"><li class="breadcrumb-item"><a href="<?php echo base_url(); ?>">Inicio</a></li><li class="breadcrumb-item">Órdenes del día</li></ol>
   </div>
</div>
...
<section class="mt-5 paddingBottom-150 bg-light-v2">
	...
	<div class="container">
		...
		<div class="row">
			...
			<?php if (empty($ordenesDia)) { ?>
                <h3 class="text-center w-100">No se encontraron documentos</h3>
			<?php } else { ?>

                <?php foreach ($ordenesDia as $documento): ?>
